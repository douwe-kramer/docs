...
or access any payment account CompanyX may use to execute an approved action.
...
connect to CompanyX's payment account. CompanyX remains responsible for any
