...
Return to the origin you registered exactly: `https://app.example.com` is allowed, but `https://app.example.com/approval-return` is **rejected** because it carries a path.
